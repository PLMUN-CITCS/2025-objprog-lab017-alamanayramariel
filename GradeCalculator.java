...
public class GradeCalculator { //Title Indicator as Foldar Name 
    public static void main(String[] args) {
        ...
        System.out.print("Enter your score: "); // Dito naman medyo di ko gets naka int si score tapos naka equal kay scanner di ko magets pano sila nagwowork together. ang hirap ng slow learner 😣
        int score = scanner.nextInt();
        
        // Determine the grade based on the score   NAG GPT NAKO Dito sir dko po talaga maimage ano gagawin ko sa LABOO17 na to 😣 
